...
const Carousel = ({ children, refContainer }) => {
  ...
  useLayoutEffect(() => {
    const reffForwardDragHandler = refDragHandler.current;

    reffForwardDragHandler.onmousedown = onDragStart;
    reffForwardDragHandler.addEventListener("touchstart", onDragStart);
    reffForwardDragHandler.addEventListener("touchend", onDragEnd);
    reffForwardDragHandler.addEventListener("touchmove", onDragMove);
    reffForwardDragHandler.addEventListener("click", onClick);
    reffForwardDragHandler.addEventListener("transitionend", fnCheckIndex);

    return () => {
      reffForwardDragHandler.removeEventListener("touchstart", onDragStart);
      reffForwardDragHandler.removeEventListener("touchend", onDragEnd);
      reffForwardDragHandler.removeEventListener("touchmove", onDragMove);
      reffForwardDragHandler.removeEventListener("click", onClick);
      reffForwardDragHandler.removeEventListener("transitionend", fnCheckIndex);
    };
